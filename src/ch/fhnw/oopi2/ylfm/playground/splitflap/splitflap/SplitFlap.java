package ch.fhnw.oopi2.ylfm.playground.splitflap.splitflap;
...
public class SplitFlap extends JComponent implements ActionListener {
	...
	private BufferedImage createBackgroundImage(final int WIDTH, final int HEIGHT) {
		...
		final LinearGradientPaint HIGHLIGHT_FILL = new LinearGradientPaint(START_HIGHLIGHT, STOP_HIGHLIGHT,
